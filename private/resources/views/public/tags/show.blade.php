...
@php
    ...
    $seoDescription = $tag->seo['description'] ?? $tag->getMetaDescription();
    $seoKeywords = (!empty($tag->seo['keywords'])) ? e($tag->seo['keywords']) : null;
@endphp
...
@push('header')
    ...
    <meta property="og:url" content="{{ $tag->permalink() }}"/>
...
@section('content')
    <main role="main" class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="col-inner">
                    {!! \App\Sidebar::sidebarDisplay( get_style('tag_sidebar') ) !!}
                </div>
            </div>
        </div>
